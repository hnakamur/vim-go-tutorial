...
8. [編集する](#edit-it)
  ...
  * [スニペット](#snippets)
9. [美しく表示する](#beautify-it)
10. [チェックする](#check-it)
11. [ナビゲート](#navigate-it)
  * [代替ファイル](#alternate-files)
  * [定義へジャンプ](#go-to-definition)
  * [関数間の移動](#move-between-functions)
12. [理解する](#understand-it)
  * [ドキュメント検索](#documentation-lookup)
  * [識別子解決](#identifier-resolution)
  * [識別子のハイライト](#identifier-highlighting)
  * [依存パッケージとファイル](#dependencies-and-files)
  * [Guru](#guru)
13. [リファクタリングする](#refactor-it)
  * [識別子をリネームする](#rename-identifiers)
  * [関数を抽出する](#extract-function)
14. [コード生成する](#generate-it)
  * [インタフェースを実装するスタブメソッド](#method-stubs-implementing-an-interface)
15. [シェアする](#share-it)
...
最も使われる機能の一つが `定義へのジャンプ` です。 vim-go は当初から
...
まず必要なプラグインをインソトールしてこれら2つのコマンドを有効にしましょう。
